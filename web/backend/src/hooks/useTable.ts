...
export const useTable = (
  ...
  const getTableList = async () => {
    ...
    try {
      ...
      // Ensure tableData is an array. If data has a list property, use it even if not pageable.
      const list = data && typeof data === 'object' && 'list' in data ? data.list : data
      state.tableData = Array.isArray(list) ? list : []
